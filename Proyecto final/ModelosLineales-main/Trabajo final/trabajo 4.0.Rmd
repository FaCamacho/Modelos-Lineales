...
$$Log(Peso_{i}) = \beta_0\ + \beta_1Log(Longitud1_{i})\ +\ \beta_2Especie\ +\ \epsilon_i$$
...
```{r}
mod3 = lm(log(Peso_gr) ~ log(Longitud1) + Especie, data = datos)
...
breusch_pagan(mod3) #No Rechazo H0) con p-valor de 0.73
...
mod1.2 <- lm(log(Peso_gr) ~ Especie + log(Longitud1) , data = datos) ## ancova 
