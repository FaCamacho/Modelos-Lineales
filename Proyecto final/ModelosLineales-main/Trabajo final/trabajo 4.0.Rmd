...
| Multiple R-squared (Mod2) | Multiple R-squared (Mod3) |
|:-------:|:------:|
| 0.994| 0.9225
...
$$Log(Peso_i) = \beta_0\ + \beta_1Log(Longitud_1)\ +\epsilon_i $$

```{r}

summary(lm(formula = log(Peso_gr) ~ log(Longitud1) + log(Altura_cm) + log(Ancho_cm), data = datos))



summary(lm(formula = log(Peso_gr) ~ log(Longitud1) , data = datos))
