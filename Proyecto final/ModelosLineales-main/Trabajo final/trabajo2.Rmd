...
biometria_peces <- read_excel("Proyecto final/ModelosLineales-main/Datos/biometria_peces.xlsx")
...
vif(lm(Peso_gr~ ., data = datos))

(lm(Peso_gr~ .-Longitud2-Longitud3, data = datos))
