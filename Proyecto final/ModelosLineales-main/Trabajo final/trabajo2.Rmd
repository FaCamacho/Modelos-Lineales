...
modelo <- lm(Peso_gr~ .-Especie-Longitud2-Longitud3, data = datos)
...
shapiro.test(datos$t_i) #Rechazo H0) con un 0.006, medio ambiciosos capaz
...
which.min(datos$Peso_gr)

which.max(datos$Peso_gr)


datos <- datos[-which.min(datos$Peso_gr),]
